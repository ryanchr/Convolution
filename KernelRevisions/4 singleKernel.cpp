                   ...
                   const float* const filter, const int filterWidth)
{
   ...
   for (rowFilter=-filterD2;rowFilter<=filterD2;rowFilter++)
   {
      for(colFilter=-filterD2;colFilter<=filterD2;colFilter++)
      {
         ...
         tempOutRed+=static_cast<float>(inputChannel[pixel_1D_pos].x)*filter[filter_pos];
         tempOutGreen+=static_cast<float>(inputChannel[pixel_1D_pos].y)*filter[filter_pos];
         tempOutBlue+=static_cast<float>(inputChannel[pixel_1D_pos].z)*filter[filter_pos];
      }
   }
                   ...
                   const float* const filter, const int filterWidth)
{
   ...
   for (rowFilter=-filterD2;rowFilter<=filterD2;rowFilter++)
   {
      for(colFilter=-filterD2;colFilter<=filterD2;colFilter++)
      {
         ...
         tempOut+=static_cast<float>(inputChannel[pixel_1D_pos])*filter[filter_pos];
      }
   }
