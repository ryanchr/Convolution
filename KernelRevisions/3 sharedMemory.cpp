                   ...
                   const float* const filter, const int filterWidth)
{
  ...
  __shared__ unsigned char temp[(BLOCK_SIZE_X+8)*(BLOCK_SIZE_Y+8)];  //£¨16+8£©*£¨16+8£©
  ...
  //   }
   ...
   //right
     ...
     int numBlock = (numRows+BLOCK_SIZE_X-1)/BLOCK_SIZE_X;
                        ...
                        const int filterWidth)
{
  ...
  const dim3 gridSize((numCols+BLOCK_SIZE_X-1)/BLOCK_SIZE_X,(numRows+BLOCK_SIZE_Y-1)/BLOCK_SIZE_Y);
...
//cudaDeviceSynchronize(); checkCudaErrors(cudaGetLastError());
  ...
  const dim3 gridSize2((numCols+BLOCK_SIZE_X-1)/BLOCK_SIZE_X, (numRows+BLOCK_SIZE_Y-1)/BLOCK_SIZE_Y);
